        ...
        <div id="main">
          ...
          <section id="second" className="main special">
            ...
            <p className="content">Our audience is a diverse mix of interests. 
              ...
              communities continues to grow. You're welcome to join us as an audience member, a sponsor, a venue partner, or even as a contributor. 🎉 What does that mean? <a href='https://cambiecollectiv/following'>Tweet at or DM any of us</a> to find out.</p>
            <footer className="major">
              <ul className="actions">
                <li><Link to="/" className="button">Learn More</Link></li>
              </ul>
