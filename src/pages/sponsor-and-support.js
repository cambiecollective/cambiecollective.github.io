        ...
        <div id="main">
          <section id="content" className="main">
            ...
            <ul>Your logo and our thanks in three emails:
              <li>To all past attendees 1 week before the event you're sponsoring.</li>
              <li>Reminding RSVPd attendees about the event you're sponsoring.</li>
              <li>Thanking the attendees for attending the event you sponsored.</li>
            </ul>
            ...
            <ul>
              ...
              <li>Your logo and our thanks on our Twitter once per week.</li>
            </ul>
